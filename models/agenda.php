...
<body>
    ...
    <div class="citasNuevas">
        <div id="formulario" style="display: none;">
            <form id="agregarCitaForm" action="../controllers/agendaController.php" method="POST"
                ...
                <div class="mb-3 row">
                    <label for="identificacionCliente" class="col-sm-2 col-form-label">Identificación del
                        cliente:</label>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="identificacionCliente" name="identificacionCliente"
                            required>
                        <div class="invalid-feedback">Este campo es obligatorio.</div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $("#eliminarCitaForm").submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#mensaje").html(
                        '<div class="alert alert-success" role="alert">Cita eliminada correctamente</div>'
                    );
                    $("#idCita").val('');
                },
                error: function(xhr, status, error) {
                    $("#mensaje").html(
                        '<div class="alert alert-danger" role="alert">Error al eliminar la cita</div>'
                    );
                }
            });
        });
